...
- [PurduePics](https://github.com/bunceandbean/PurduePics) - A Python-based [twitter bot](https://twitter.com/PurduePics) that posts takes daily photos of the Purdue Engineering Mall. The bot is hosted and managed on a cloud server. Say Cheese!
